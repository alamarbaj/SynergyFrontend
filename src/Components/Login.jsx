...
export default function Login(setLoginUser) {
    ...
    var { loginUser } = useContext(CrudeAPIContext)
    ...
    async function postData(e) {
        ...
        const authUser =    response.data.find((item)=>item.email===user.email && item.password===user.password)
                ...
                <div className="col-md-6 col-12">
                    ...
                    <form onSubmit={postData}>
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name='email' onChange={getData} placeholder='Enter Email to login to Your Account' />
                        ...
                        <button type="submit" className="background text-light mybtn w-100 p-1 rounded-1">Login</button>
